...
public class Cashier_DetailPembayaranPenjualan extends AppCompatActivity {
    private EditText cari;
    private Cashier_DetailPembayaranPenjualan_Adapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPenjualan();
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Cashier_DetailPembayaranPenjualan.this, Cashier_Pembayaran.class);
                intent.putExtra("isTransaksiLayanan", 0);
    ...
    private void init(){
        ...
        mAdapter = new Cashier_DetailPembayaranPenjualan_Adapter(this, mItems);
