...
public class TransaksiLayananKeranjang_Edit extends AppCompatActivity {
    ...
    private void getDetail() {
        String url = ip + this.url + "index.php/DetilTransaksiLayanan/detail/"+id;
        ...
        JsonObjectRequest arrayRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    nama_layanan.setText(massageDetail.getString("nama_layanan"));

                    Locale localeID = new Locale("in", "ID");
                    NumberFormat formatRupiah = NumberFormat.getCurrencyInstance(localeID);
                    harga_layanan = massageDetail.getDouble("harga");
                    harga.setText(formatRupiah.format(harga_layanan));
                    nama_hewan.setText(massageDetail.getString("nama_hewan"));

                    jumlah.setText(String.valueOf(massageDetail.getInt("jumlah")));
                    tanggal_lahir.setText(massageDetail.getString("tanggal_lahir"));

                    id_jenis_hewan = massageDetail.getInt("id_jenis_hewan");
                    id_layanan = massageDetail.getInt("id_layanan");
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < massage.length(); i++) {
                        ...
                        if (id_jenis_hewan == massageDetail.getInt("id")) {
                            jenis_hewan.setSelection(i);
                        }
    ...
    private void init() {
        ...
        edit = findViewById(R.id.cs_transaksi_layanan_keranjang_tambah_add);
